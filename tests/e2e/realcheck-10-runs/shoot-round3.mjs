...
const TARGETS = [
  { idx: 2, label: '凤栖梧',     projectId: 'project_mpo77llv_p3uijq' },
  { idx: 4, label: '雾港谜局',   projectId: 'project_mpo7818v_ce9a51' },
];

async function shoot() {
  const dir = 'E:/CC/code/yuandian-screenwriting-system/tests/e2e/realcheck-shots/round3';
