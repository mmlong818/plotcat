...
await page.waitForTimeout(600);
await page.screenshot({ path: 'tests/e2e/audit-2026-06-10/dark-scenes-after.png' });
// 顺手检查其他步骤的暗色可读性
for (const step of ['structure','characters','plots','screenplay']) {
  await page.click(`[data-action="go-step"][data-id="${step}"]`);
  await page.waitForTimeout(500);
  await page.screenshot({ path: `tests/e2e/audit-2026-06-10/dark-${step}-after.png` });
}
await browser.close();
